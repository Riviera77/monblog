    ...
    <div class="isolate bg-gray-900 px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl text-center">
            <h2
                ...
                📬 Contact</h2>
            <p class="mt-2 text-lg/8 text-gray-400">Une question ? Une
                collaboration
                ? Écrivez-moi !</p>
        </div>
        <form action="#" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
            <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                ...
                <div>
                    <label for="last-name"
                        class="block text-sm/6 font-semibold text-white">Nom</label>
                    <div class="mt-2.5">
                ...
                <div class="sm:col-span-2">
                    <label for="phone-number"
                        class="block text-sm/6 font-semibold text-white">Phone
                        number</label>
                    <div class="mt-2.5">
                        <div
                ...
                <div class="flex gap-x-4 sm:col-span-2">
                    ...
                    <label for="agree-to-policies"
                        class="text-sm/6 text-gray-400">
                        En cochant, vous acceptez nos
                        <a href="#"
                            class="font-semibold whitespace-nowrap text-indigo-400">politiques
            ...
            <div class="mt-10">
                <button type="submit"
                    class="block w-full rounded-md bg-purple-700 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-xs hover:bg-purple-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Parlons
                    en!</button>
            </div>
        </form>
    </div>
