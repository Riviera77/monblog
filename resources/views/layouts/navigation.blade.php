<nav x-data="{ open: false }"
    class="bg-purple-800 text-white sticky top-0 z-50 shadow">
        ...
        <div class="flex justify-between items-center h-16">
            ...
            <div class="shrink-0 flex items-center space-x-3">
                <img src="{{ asset('images/logo.png') }}" alt="Logo"
                    class="h-10 w-auto">
                <a href="/"
                    class="text-xl font-bold text-white">CodingQueen40</a>
            </div>
            ...
            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                <x-nav-link :href="route('home')"
                    ...
                    class="text-white hover:text-blue-200 font-medium text-base sm:text-lg">
                    Accueil
                </x-nav-link>
            ...
            <!-- Connexion ou Déconnexion selon l'état desktop -->
            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                @guest
